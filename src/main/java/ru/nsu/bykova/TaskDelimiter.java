...
class TaskDelimiter {
  ...
  void checkArguments(int threadIndex) throws IllegalArgumentException {
    if (threadIndex >= threadNumber) {
      ...
      // https://docs.oracle.com/javase/8/docs/api/java/lang/Runnable.html#run-- не выбрасывает
      // исключения
      ...
      // http://www-public.imtbs-tsp.eu/~gibson/Teaching/CSC7322/L8-ExceptionsAndThreads.pdf на 32
      // слайде
